  ...
  export default function SalesConsultancyPage() {
    ...
    return (
      <div className="min-h-screen bg-[#f7f6f3] text-[#080810]">
        <SEO
  title="Sales Consultancy | Podosphere Technologies"
  description="Improve sales conversions with Podosphere Technologies through sales process design, follow-up systems, SOPs, scripts, dashboards, and sales consultancy."
/>
        <CursorAura />
        <SiteHeader basePath="/" />
